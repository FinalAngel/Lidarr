...
namespace NzbDrone.Core.DecisionEngine.Specifications
{
    public class QueueSpecification : IDecisionEngineSpecification
    {
        ...
        public Decision IsSatisfiedBy(RemoteAlbum subject, SearchCriteriaBase searchCriteria)
        {
            ...
            var matchingArtist = queue.Where(q => q.RemoteAlbum.Artist != null && q.RemoteAlbum.Artist.Id == subject.Artist.Id);
            var matchingAlbum = matchingArtist.Where(q => q.RemoteAlbum.Albums.Select(e => e.Id).Intersect(subject.Albums.Select(e => e.Id)).Any());
